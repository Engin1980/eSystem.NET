...
//    {
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<InheritedPropertyTest>());
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<PropertyParent>());
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<PropertyChild>());
...
//        });
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<InheritedPropertyTest>(xti));
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<PropertyParent>());
//      exml.ElementSerializers.Push(new SpecificTypeElementSerializer<PropertyChild>());
