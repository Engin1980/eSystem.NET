...
//    {
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<InheritedPropertyTest>());
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<PropertyParent>());
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<PropertyChild>());
...
//        });
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<InheritedPropertyTest>(xti));
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<PropertyParent>());
//      exml.ElementDeserializers.Push(new SpecificTypeElementDeserializer<PropertyChild>());
